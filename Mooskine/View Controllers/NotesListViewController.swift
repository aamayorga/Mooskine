...
extension NotesListViewController: NSFetchedResultsControllerDelegate {
    ...
    func setupFetchedResultsController() {
        ...
        fetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: dataController.viewContext, sectionNameKeyPath: nil, cacheName: "\(notebook.name!)'s Notes")
        fetchedResultsController.delegate = self
        
        do {
            try fetchedResultsController.performFetch()
        } catch {
            fatalError("The error: \(error.localizedDescription)")
        }
    }
}
